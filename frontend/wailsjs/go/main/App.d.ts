...
export function AddIfeoEntry(arg1:string,arg2:string):Promise<boolean>;
...
export function SetDns(arg1:string):Promise<boolean>;
...
export function UninstallAppx(arg1:string):Promise<boolean>;
